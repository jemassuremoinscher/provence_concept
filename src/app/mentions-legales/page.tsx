...
export default function Page() {
  return (
    <LegalDoc title="Mentions légales" updated="20 juin 2026">
      ...
      <ul>
        <li>Raison sociale : <strong>MAMMOUTH PATRIMOINE</strong> (nom commercial : VDR CONSULTING)</li>
        <li>Forme juridique : <strong>SASU — société par actions simplifiée unipersonnelle</strong></li>
        <li>Capital social : <strong>1 000 €</strong></li>
        <li>Siège social : <strong>Villa Diable Rouge, 2 rue d’Angleterre, 06000 Nice</strong></li>
        <li>SIREN : <strong>893 960 146</strong> — SIRET (siège) : <strong>893 960 146 00023</strong></li>
        <li>RCS : <strong>893 960 146 R.C.S. Nice</strong></li>
        <li>N° TVA intracommunautaire : <strong>FR06 893 960 146</strong></li>
        <li>Adresse e-mail : <strong>contact@provence-concept.fr</strong></li>
        <li>Directeur de la publication : <strong>Paul Vuillier</strong></li>
      </ul>
