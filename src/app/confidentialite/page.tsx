...
export default function Page() {
  return (
    <LegalDoc title="Politique de confidentialité" updated="20 juin 2026">
      ...
      <p>
        Le responsable du traitement est <strong>[Raison sociale]</strong>, <strong>[adresse]</strong>,
      ...
      <p>
        ...
        (hébergeur, prestataire de paiement, transporteur, outil d’e-mailing). Aucune donnée n’est
        vendue à des tiers.
      </p>
