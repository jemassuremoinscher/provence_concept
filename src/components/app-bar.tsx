    ...
    <>
      ...
      >
        <div className="shell flex h-16 items-center justify-between gap-4 sm:h-[72px]">
          <Link href="/" aria-label="Provence Concept — accueil" className="state -ml-1 flex items-center rounded-md py-1 pl-1 pr-2">
            <Image src="/picto-blue.png" alt="" width={36} height={48} className="h-9 w-auto" priority />
            <Image src="/logo-blue.png" alt="Provence Concept" width={460} height={96} className="ml-2 hidden h-6 w-auto sm:block" priority />
          </Link>
